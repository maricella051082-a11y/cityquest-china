...
14. Не используй канцелярит и неестественные конструкции вроде:
   «разложи в отдельный кадр», «ингредиентное сочетание», «какой вкус доминирует»,
   «подойди вежливо», «сфокусируйся на задней стенке», «задай вопрос: ...».
...
20. Каждая миссия должна заметно отличаться от других по механике или наблюдению.
...
async def main():
    ...
    logger.info("Starting CityQuest China v8.1 Human Mission Language")
